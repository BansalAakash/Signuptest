...
public class UpdateVideo {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Preserve any videoTags already associated with the video. If the
            // video does not have any videoTags, create a new array. Append the
            // provided tag to the list of videoTags associated with the video.
